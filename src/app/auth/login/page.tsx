...
export default function LoginPageWrapper() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-surface flex items-center justify-center"><div className="animate-spin h-6 w-6 border-2 border-accent border-t-transparent rounded-full" /></div>}>
            <LoginPage />
        </Suspense>
    );
}
        ...
        <div className="min-h-screen bg-surface flex items-center justify-center px-4">
            <div className="w-full max-w-md animate-smooth-reveal">
                ...
                <div className="bg-white rounded-3xl shadow-xl shadow-primary/5 border border-surface-warm/40 p-8 md:p-10">
                    <h2 className="font-display text-2xl font-semibold text-center text-primary mb-7 tracking-wide">
                        Giriş Yap
                    </h2>
                    ...
                    <div className="mt-7 text-center">
                        <Link
                            ...
                            className="font-body text-sm text-accent hover:text-accent-muted transition-colors duration-200"
                        >
                            Şifreni mi unuttun?
                        </Link>
                    </div>
